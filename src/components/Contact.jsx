        ...
        <div className='text-black bg-slate-50' id='contact'>
            <div className='container flex flex-col items-center justify-center h-full px-4 mx-auto md:px-8 lg:px-16'>
                <section ref={ref} className="bg-white">
                    ...
                    >
                        <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-center text-gray-900 dark:text-white sm:text-4xl">
                            Contact Us
                        </h2>
                        ...
                        <form action="#" className="space-y-6">
                            ...
                            >
                                ...
                                <input
                                    type="email"
                                    id="email"
                                    className="shadow-sm bg-gray-50 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
