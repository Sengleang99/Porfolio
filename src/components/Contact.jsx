                ...
                <section ref={ref} className="bg-white dark:bg-gray-900">
                    ...
                    >
                        ...
                        <form action="#" className="space-y-8">
                            ...
                            <motion.button
                                type="submit"
                                className="px-5 py-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg sm:w-fit hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-primary-800"
